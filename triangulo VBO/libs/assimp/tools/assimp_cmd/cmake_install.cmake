# Install script for directory: /home/pablo/repositorioGit/ICG/assimp-4.1.0/tools/assimp_cmd
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "assimp-bin")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/pablo/repositorioGit/ICG/assimp-4.1.0/bin/assimp")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp"
         OLD_RPATH "/home/pablo/repositorioGit/ICG/assimp-4.1.0:/home/pablo/repositorioGit/ICG/assimp-4.1.0/lib:"
         NEW_RPATH "")
